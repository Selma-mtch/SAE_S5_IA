...
# -*- coding: utf-8 -*-
"""
# Modèle d'ethnicité UTKFace - Architecture Complexe (VGG-style)
...
"""## 3. Création du modèle CNN Complexe (VGG-style)"""
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_PATH, 'training_curves_complexe.png'), dpi=150)
plt.show()
...
plt.title('Matrice de confusion - Modèle Complexe (VGG-style)')
plt.xlabel('Prédit')
plt.ylabel('Réel')
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_PATH, 'confusion_matrix_complexe.png'), dpi=150)
plt.show()

"""## 8. Sauvegarde du modèle"""

model.save(os.path.join(OUTPUT_PATH, 'ethnicity_model_complexe.keras'))
print(f"Modèle sauvegardé : {OUTPUT_PATH}/ethnicity_model_complexe.keras")
...
ax.set_ylabel('Score (%)')
ax.set_title('Performances par classe - Modèle Complexe (VGG-style)')
ax.set_xticks(x)
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_PATH, 'metrics_per_class_complexe.png'), dpi=150)
plt.show()

# Résumé final
print("=" * 60)
print("RÉSUMÉ FINAL - MODÈLE COMPLEXE (VGG-STYLE)")
print("=" * 60)
print(f"\nArchitecture :")
...
print("=" * 60)
print("  - ethnicity_model_complexe.keras")
print("  - training_curves_complexe.png")
print("  - confusion_matrix_complexe.png")
print("  - metrics_per_class_complexe.png")
