...
# -*- coding: utf-8 -*-
"""
# Modèle d'ethnicité UTKFace - Poids de "Autre" réduit

**Entraînement sur Kaggle**

**Modification :**
- Réduction du poids de la classe "Autre" (classe 4) pour limiter son impact
- Le modèle se concentre sur les 4 classes principales

**Preprocessing :**
- Images en niveaux de gris (1 canal)
- Redimensionnement 128x128
- Normalisation /255
- Class weights modifiés (Autre réduit)
...
# Le modèle apprend uniquement sur les 4 classes principales
...
# Résumé final
print("=" * 60)
print("RÉSUMÉ FINAL - POIDS 'AUTRE' RÉDUIT")
print("=" * 60)
print(f"\nFacteur de réduction pour 'Autre' : {REDUCTION_FACTOR} (10%)")
